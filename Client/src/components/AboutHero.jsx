    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            IIITBH'25 || Bachelor of Engineering in Electronics & Communication Engineering || Web
          ...
          <div className="flex flex-col items-center md:flex-row">
            ...
            >
              <p className="text-lg font-semibold text-gray-900 dark:text-gray-300">
                ⚡Currently, as a student at Indian Institute of Information Technology, Bhagalpur, I am always excited to work on new technologies.💙
...
export const Skills = () => {
  const skills = [
    ...
    { 
      name: "Vercel", 
      icon: <SiVercel className="text-black dark:text-gray-50" />,
    },
